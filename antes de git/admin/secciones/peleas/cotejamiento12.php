        ...
        <div class="d-flex flex-column col-6">
            ...
            <div class="card-body">
                <form id="formCotejoManual" action="" method="POST">
                    <div class=" card d-flex table-responsive">
                        <?php
                    ...
                    <div class="d-flex flex-row table-responsive">
                        ...
                        if ((!empty($toleranciaPeso) && $toleranciaPeso != 0) && (!empty($toleranciaAltura) && $toleranciaAltura != 0)) :
                            ...
                            for ($index1 = 0; $index1 < $cantidadGallos; $index1++) {
                                ...
                                $cotejadoManualmente = false;
                                foreach ($resultado as $pareja) {
                                    if ($pareja['gallo1']['ID'] == $gallo1['ID'] || $pareja['gallo2']['ID'] == $gallo1['ID']) {
                                        $cotejadoManualmente = true;
                                        break;
                                    }
                                }
                                if ($cotejadoManualmente) {
                                    continue;
                                }
