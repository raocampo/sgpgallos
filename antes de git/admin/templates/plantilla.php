        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="../secciones/representantes/crear.php">Agregar</a></li>
                ...
                <li>
					...
					<ul class="sub">
						<li><a href="../secciones/familias/crear.php">Agregar</a></li>
					</ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
                        <li><a href="../secciones/gallos/crear.php">Ingresar Gallos</a></li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="../secciones/gallos/crear.php">Crear Torneo</a></li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="mail.html">Ingresar</a></li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="../secciones/usuarios/crear.php">Registrar Usuario</a></li>
