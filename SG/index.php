...
<!DOCTYPE html>
<head>
<title>Sistema de Gestion de Coteja y Peleas de Gallos</title>
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li><a href="<?php echo $url_base;?>secciones/torneos/">Cotejamiento</a></li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li>
                        <!--<a href="mail_compose.html">Compose Mail</a></li>-->
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="<?php echo $url_base;?>login.php">Ingresar</li>
                    </ul>
                </li>
            </ul>            
        </div>
