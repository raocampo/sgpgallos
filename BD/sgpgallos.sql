...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-07-2023 a las 18:26:17
...
--
-- Volcado de datos para la tabla `coteja`
--

INSERT INTO `coteja` (`ID_Coteja`, `galloL`, `galloV`, `estado`, `torneoId`) VALUES
(79, '29', '10', 0, 1),
(90, '96', '113', 0, 2),
(91, '174', '111', 0, 2),
(92, '120', '152', 0, 2),
...
--
ALTER TABLE `coteja`
  MODIFY `ID_Coteja` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100;
...
--
ALTER TABLE `exclusiones`
  MODIFY `IdExclusion` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `peleas`
  MODIFY `ID_Pelea` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
